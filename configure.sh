...
echo "@c Autogenerated." > doc_info/make.in.texi
echo "@set TITLE $FPM_NAME" >> doc_info/make.in.texi
echo "@set VERSION $FPM_VERSION" >> doc_info/make.in.texi
echo "@set AUTHOR $FPM_AUTHOR" >> doc_info/make.in.texi
echo "@set LIBNAME $FPM_LIBNAME" >> doc_info/make.in.texi
