...
echo -n "Generating variables to doc/src/make.in.tex..."
echo "% Autogenerated." > doc/src/make.in.tex
echo "\\def\\VERSION{$FPM_VERSION}" >> doc/src/make.in.tex
echo "\\def\\AUTHOR{$FPM_AUTHOR}" >> doc/src/make.in.tex
echo "\\def\\NAME{$FPM_NAME}" >> doc/src/make.in.tex
echo "\\def\\LIBNAME{$FPM_LIBNAME}" >> doc/src/make.in.tex
echo "done."
