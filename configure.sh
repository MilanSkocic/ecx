...
echo "[INFO]: Generating env variables to make.in."
...
echo "PREP_DOCUMENT_DIR=$PREP_DOCUMENT_DIR"
echo "export PREP_DOCUMENT_DIR=$PREP_DOCUMENT_DIR" >> make.in
echo "MANWIDTH=$MANWIDTH"
echo "export MANWIDTH=$MANWIDTH" >> make.in
echo "[INFO]: Env variables done."

echo "[INFO]: Generating env variables to doc/src/make.in.texi"
echo "@c Autogenerated." > doc/src/make.in.texi
echo "@set TITLE $FPM_NAME" >> doc/src/make.in.texi
echo "@set VERSION $FPM_VERSION" >> doc/src/make.in.texi
echo "@set AUTHOR $FPM_AUTHOR" >> doc/src/make.in.texi
echo "@set LIBNAME $FPM_LIBNAME" >> doc/src/make.in.texi
echo "[INFO]: Texinfo variables done."

echo "[INFO]: Copying env vars and license to python."
cp -f make.in ./py/make.in
cp -f LICENSE ./py/LICENSE

# Add permissions
echo "[INFO]: Chmod +x for doc/build.sh"
